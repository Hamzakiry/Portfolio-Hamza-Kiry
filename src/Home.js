        ...
        <div className="mx-auto sm:px-6 lg:px-8 xl:px-12">
          <div className="flex h-16 items-center justify-between lg:h-[72px]">
            <div className="flex flex-shrink-0 items-center">
              <a
                className="flex items-center font-bold text-xl no-underline hover:no-underline"
                href="/"
              >
...
export const products = [
  {
    title: "Hamza Kiry Portfolio Preview 1",
    link: "https://github.com/Hamzakiry/Python-Invaders-Game-main",
    thumbnail: Pro1,
  },
  {
    title: "Hamza Kiry Portfolio Preview 2",
    link: "https://github.com/Hamzakiry/ecommerce",
    thumbnail: Pro2,
  },
  {
    title: "Hamza Kiry Portfolio Preview 3",
    link: "https://github.com/hamzakiry",
    thumbnail: Pro3,
  },
  {
    title: "Hamza Kiry Portfolio Preview 4",
    link: "https://github.com/Hamzakiry/sneaks",
    thumbnail: Pro4,
  },
  
  {
    title: "Hamza Kiry Portfolio Preview 7",
    link: "https://github.com/Hamzakiry/FaceRecognition-kotlin",
    thumbnail: Pro7,
  },
  {
    title: "Hamza Kiry Portfolio Preview 8",
    link: "https://github.com/Hamzakiry/al-karama",
    thumbnail: Pro8,
  },
  {
    title: "Hamza Kiry Portfolio Preview 9",
    link: "https://github.com/Hamzakiry/Hosmony-RSE-Atlas",
    thumbnail: Pro9,
  },
